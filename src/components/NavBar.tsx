    ...
    <>
      <div className="container content-center p-2 bg-[#201E43] flex items-center">
        ...
        <div className="w-[1000px] flex justify-center">
          ...
          />
          <button className="bg-destructive h-[40px] w-[50px]">
            <img className="h-[20px] ml-3 w-[auto]" src={Searching} />
          </button>
        </div>
        <div className="content-center mr-3 flex items-center text-white">
          <Link to="/" className="m-4 hover:text-zinc-400">
            Home
          </Link>
          <a href="#" className="m-4 hover:text-zinc-400">
            About
          </a>
          <a href="#" className="m-4 hover:text-zinc-400">
            Login
          </a>
          <Link to="/Cart" className="w-[30px] h-[30px">
